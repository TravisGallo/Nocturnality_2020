...
**2021_Gallo_etal_DielActivity_cleaned_photo_dataset_9_species.rds** - A cleaned dataset of photo observations for only the species and cities that we analyzed.
